...
interface ContractFunctions {
    ...
    merchantSignup: (payment: {
        value: string;
    }) => Promise<TransactionResponse>;
    getMerchantId: () => Promise<BigInt>;
    addProduct: (tokenAddress: EVMAddress, amount: string, commAdd: EVMAddress, commPer: string, qty: string, payment: {
        value: string;
    }) => Promise<TransactionResponse>;
    updateProduct: (token: EVMAddress, amount: string, commAdd: EVMAddress, commPer: string, qty: string, productId: string) => Promise<TransactionResponse>;
    deleteProduct: (productId: string) => Promise<TransactionResponse>;
    getProducts: (pageNo: string, pageSize: string, merchantId: string) => Promise<[ProductRaw[], BigInt]>;
    productDetails: (productId: string) => Promise<ProductRaw>;
    payProduct: (productId: string, quantity: string, payment?: {
        value: string;
    }) => Promise<TransactionResponse>;
    getPayments: (pageNo: string, pageSize: string, merchantId: string, buyer: EVMAddress) => Promise<[PaymentRaw[], BigInt]>;
    totalFeesPaid: () => Promise<BigInt>;
    stakesCount: () => Promise<[BigInt, BigInt]>;
    transferStake: (stakeUnits: string, recipientAddress: EVMAddress) => Promise<TransactionResponse>;
    offerStake: (stakeUnits: string, valuePerStake: string) => Promise<TransactionResponse>;
    stakesOffered: () => Promise<[BigInt[], BigInt[], boolean[], BigInt]>;
    removeStakeOffer: (offerId: string) => Promise<TransactionResponse>;
    takeStake: (offerId: string, payment: {
        value: string;
    }) => Promise<TransactionResponse>;
    getTokenData: (tokenAddress: EVMAddress) => Promise<TokenDataRaw>;
    tokenRate: (tokenAddress: EVMAddress, referenceWei: string, referenceAddress: EVMAddress) => Promise<BigInt>;
}
